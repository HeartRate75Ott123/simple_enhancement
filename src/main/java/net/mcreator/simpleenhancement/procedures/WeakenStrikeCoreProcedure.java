...
@EventBusSubscriber
public class WeakenStrikeCoreProcedure {
    private static final ResourceLocation ENCHANT_ID = ResourceLocation.fromNamespaceAndPath("simple_enhancement", "weaken_strike");
    ...
    public static void onEntityAttacked(LivingIncomingDamageEvent event) {
        ...
        if (event.getEntity() instanceof LivingEntity target) {
            target.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, enchantLevel * 40, enchantLevel - 1));
        }
    }
}